...
//                        browser = browser;
    ...
    public static void openURL(String url) throws IOException {
        ...
        switch (jvm) {
            ...
            case MRJ_3_1:
                //GDN change start
                // openURL.invoke (below) doesn't handle url strings with spaces (at least)
                // but will work when the spaces are encoded to %20. There may be
                // problems with other "unsafe" characters as well but I haven't tested
                // for other than spaces. I tried using java.net.URLEncoder.encode()
                // to do the encoding but that caused other problems so I'm just going
                // to replace spaces with %20 as a (perhaps partial) workaround.
                //
